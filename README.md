...
2. Open **Installer**. GLoader automatically scans accessible internal shared storage, connected removable storage volumes, and readable `/storage/XXXX-XXXX` mount paths, then lets you switch the results between internal and external APKs.
